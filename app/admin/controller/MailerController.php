...
class MailerController extends AdminBaseController
{
    ...
    {
        $emailSetting = imf_get_option('smtp_setting');
    ...
    public function indexPost()
    {
        ...
        imf_set_option('smtp_setting', $post);
    ...
    public function template()
    {
        ...
        $template = imf_get_option('email_template_' . $templateKey);
    ...
    public function templatePost()
    {
        ...
        imf_set_option('email_template_' . $templateKey, $data);
    ...
    public function test()
    {
        if ($this->request->isPost()) {
            ...
            $result = imf_send_email($data['to'], $data['subject'], $data['content']);
