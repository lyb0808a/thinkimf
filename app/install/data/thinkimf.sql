...
CREATE TABLE IF NOT EXISTS `ud_admin_menu` (
...
CREATE TABLE IF NOT EXISTS `ud_asset` (
...
CREATE TABLE IF NOT EXISTS `ud_auth_access` (
  `id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ud_auth_rule` (
...
CREATE TABLE IF NOT EXISTS `ud_comment` (
  `id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ud_hook` (
  `id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ud_hook_plugin` (
  `id` int(10) unsigned NOT NULL,
  `list_order` float NOT NULL DEFAULT '10000' COMMENT '排序',
...
CREATE TABLE IF NOT EXISTS `ud_link` (
  `id` bigint(20) unsigned NOT NULL,
...
INSERT INTO `ud_link` (`id`, `status`, `rating`, `list_order`, `description`, `url`, `name`, `image`, `target`, `rel`) VALUES
(1, 1, 1, 8, 'thinkcmf官网', 'https://www.thinkimf.com', 'ThinkIMF', '', '_blank', '');
...
CREATE TABLE IF NOT EXISTS `ud_nav` (
  `id` int(10) unsigned NOT NULL,
...
INSERT INTO `ud_nav` (`id`, `is_main`, `name`, `remark`) VALUES
(1, 1, '主导航', '主导航'),
(2, 0, '底部导航', '');
...
CREATE TABLE IF NOT EXISTS `ud_nav_menu` (
  `id` int(11) NOT NULL,
...
INSERT INTO `ud_nav_menu` (`id`, `nav_id`, `parent_id`, `status`, `list_order`, `name`, `target`, `href`, `icon`, `path`) VALUES
...
CREATE TABLE IF NOT EXISTS `ud_option` (
  `id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ud_plugin` (
...
--
-- 表的结构 `ud_portal_category`
--

CREATE TABLE IF NOT EXISTS `ud_portal_category` (
...
--
-- 表的结构 `ud_portal_category_post`
--

CREATE TABLE IF NOT EXISTS `ud_portal_category_post` (
  `id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ud_portal_post` (
  `id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ud_portal_tag` (
  `id` bigint(20) unsigned NOT NULL COMMENT '分类id',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态,1:发布,0:不发布',
  `recommended` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否推荐;1:推荐;0:不推荐',
...
--
-- 表的结构 `ud_portal_tag_post`
--

CREATE TABLE IF NOT EXISTS `ud_portal_tag_post` (
...
CREATE TABLE IF NOT EXISTS `ud_recycle_bin` (
  `id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ud_role` (
  `id` int(10) unsigned NOT NULL,
...
INSERT INTO `ud_role` (`id`, `parent_id`, `status`, `create_time`, `update_time`, `list_order`, `name`, `remark`) VALUES
...
CREATE TABLE IF NOT EXISTS `ud_role_user` (
  `id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ud_route` (
...
CREATE TABLE IF NOT EXISTS `ud_slide` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ud_slide_item` (
  `id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ud_theme` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ud_theme_file` (
  `id` int(11) NOT NULL,
...
--
-- 表的结构 `ud_third_party_user`
--

CREATE TABLE IF NOT EXISTS `ud_third_party_user` (
  `id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ud_user` (
  ...
  `user_pass` varchar(64) NOT NULL DEFAULT '' COMMENT '登录密码;ud_password加密',
...
--
-- 表的结构 `ud_user_action_log`
--

CREATE TABLE IF NOT EXISTS `ud_user_action_log` (
  `id` bigint(20) unsigned NOT NULL,
  `user_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
...
--
-- 表的结构 `ud_user_favorite`
--

CREATE TABLE IF NOT EXISTS `ud_user_favorite` (
  `id` bigint(20) unsigned NOT NULL,
...
--
-- 表的结构 `ud_user_login_attempt`
--

CREATE TABLE IF NOT EXISTS `ud_user_login_attempt` (
  `id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ud_user_token` (
  `id` bigint(20) NOT NULL,
...
--
-- 表的结构 `ud_verification_code`
--

CREATE TABLE IF NOT EXISTS `ud_verification_code` (
...
--
-- Indexes for table `ud_admin_menu`
--
ALTER TABLE `ud_admin_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ud_asset`
--
ALTER TABLE `ud_asset`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_auth_access`
--
ALTER TABLE `ud_auth_access`
  ADD PRIMARY KEY (`id`),
  ADD KEY `role_id` (`role_id`),
  ADD KEY `rule_name` (`rule_name`) USING BTREE;

--
-- Indexes for table `ud_auth_rule`
--
ALTER TABLE `ud_auth_rule`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`) USING BTREE,
  ADD KEY `module` (`app`,`status`,`type`);

--
-- Indexes for table `ud_comment`
--
ALTER TABLE `ud_comment`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ud_hook`
--
ALTER TABLE `ud_hook`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_hook_plugin`
--
ALTER TABLE `ud_hook_plugin`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_link`
--
ALTER TABLE `ud_link`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ud_nav`
--
ALTER TABLE `ud_nav`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_nav_menu`
--
ALTER TABLE `ud_nav_menu`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_option`
--
ALTER TABLE `ud_option`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `option_name` (`option_name`);

--
-- Indexes for table `ud_plugin`
--
ALTER TABLE `ud_plugin`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_portal_category`
--
ALTER TABLE `ud_portal_category`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_portal_category_post`
--
ALTER TABLE `ud_portal_category_post`
  ADD PRIMARY KEY (`id`),
  ADD KEY `term_taxonomy_id` (`category_id`);

--
-- Indexes for table `ud_portal_post`
--
ALTER TABLE `ud_portal_post`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ud_portal_tag`
--
ALTER TABLE `ud_portal_tag`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_portal_tag_post`
--
ALTER TABLE `ud_portal_tag_post`
  ADD PRIMARY KEY (`id`),
  ADD KEY `term_taxonomy_id` (`post_id`);

--
-- Indexes for table `ud_recycle_bin`
--
ALTER TABLE `ud_recycle_bin`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_role`
--
ALTER TABLE `ud_role`
  ADD PRIMARY KEY (`id`),
  ADD KEY `parentId` (`parent_id`),
...
--
-- Indexes for table `ud_role_user`
--
ALTER TABLE `ud_role_user`
  ADD PRIMARY KEY (`id`),
  ADD KEY `group_id` (`role_id`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `ud_route`
--
ALTER TABLE `ud_route`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_slide`
--
ALTER TABLE `ud_slide`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_slide_item`
--
ALTER TABLE `ud_slide_item`
  ADD PRIMARY KEY (`id`),
  ADD KEY `slide_cid` (`slide_id`);

--
-- Indexes for table `ud_theme`
--
ALTER TABLE `ud_theme`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_theme_file`
--
ALTER TABLE `ud_theme_file`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_third_party_user`
--
ALTER TABLE `ud_third_party_user`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_user`
--
ALTER TABLE `ud_user`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ud_user_action_log`
--
ALTER TABLE `ud_user_action_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_object_action` (`user_id`,`object`,`action`),
  ADD KEY `user_object_action_ip` (`user_id`,`object`,`action`,`ip`);

--
-- Indexes for table `ud_user_favorite`
--
ALTER TABLE `ud_user_favorite`
  ADD PRIMARY KEY (`id`),
  ADD KEY `uid` (`user_id`);

--
-- Indexes for table `ud_user_login_attempt`
--
ALTER TABLE `ud_user_login_attempt`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_user_token`
--
ALTER TABLE `ud_user_token`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ud_verification_code`
--
ALTER TABLE `ud_verification_code`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ud_admin_menu`
--
ALTER TABLE `ud_admin_menu`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=154;
--
-- AUTO_INCREMENT for table `ud_asset`
--
ALTER TABLE `ud_asset`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `ud_auth_access`
--
ALTER TABLE `ud_auth_access`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ud_auth_rule`
--
ALTER TABLE `ud_auth_rule`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '规则id,自增主键',AUTO_INCREMENT=154;
--
-- AUTO_INCREMENT for table `ud_comment`
--
ALTER TABLE `ud_comment`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ud_hook`
--
ALTER TABLE `ud_hook`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT for table `ud_hook_plugin`
--
ALTER TABLE `ud_hook_plugin`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `ud_link`
--
ALTER TABLE `ud_link`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ud_nav`
--
ALTER TABLE `ud_nav`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `ud_nav_menu`
--
ALTER TABLE `ud_nav_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `ud_option`
--
ALTER TABLE `ud_option`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `ud_plugin`
--
ALTER TABLE `ud_plugin`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增id',AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `ud_portal_category`
--
ALTER TABLE `ud_portal_category`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类id',AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `ud_portal_category_post`
--
ALTER TABLE `ud_portal_category_post`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=117;
--
-- AUTO_INCREMENT for table `ud_portal_post`
--
ALTER TABLE `ud_portal_post`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=32;
--
-- AUTO_INCREMENT for table `ud_portal_tag`
--
ALTER TABLE `ud_portal_tag`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类id',AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `ud_portal_tag_post`
--
ALTER TABLE `ud_portal_tag_post`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ud_recycle_bin`
--
ALTER TABLE `ud_recycle_bin`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT for table `ud_role`
--
ALTER TABLE `ud_role`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `ud_role_user`
--
ALTER TABLE `ud_role_user`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `ud_route`
--
ALTER TABLE `ud_route`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '路由id',AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `ud_slide`
--
ALTER TABLE `ud_slide`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ud_slide_item`
--
ALTER TABLE `ud_slide_item`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ud_theme`
--
ALTER TABLE `ud_theme`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `ud_theme_file`
--
ALTER TABLE `ud_theme_file`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=105;
--
-- AUTO_INCREMENT for table `ud_third_party_user`
--
ALTER TABLE `ud_third_party_user`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ud_user`
--
ALTER TABLE `ud_user`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `ud_user_action_log`
--
ALTER TABLE `ud_user_action_log`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `ud_user_favorite`
--
ALTER TABLE `ud_user_favorite`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `ud_user_login_attempt`
--
ALTER TABLE `ud_user_login_attempt`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ud_user_token`
--
ALTER TABLE `ud_user_token`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `ud_verification_code`
--
ALTER TABLE `ud_verification_code`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '表id',AUTO_INCREMENT=9;

ALTER TABLE `ud_route` ADD `type` TINYINT NOT NULL DEFAULT '1' COMMENT 'URL规则类型;1:用户自定义;2:别名添加' AFTER `status`;

-- 2017-09-12 12:38 更改字段长度
ALTER TABLE `ud_hook` CHANGE `hook` `hook` VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '钩子';
ALTER TABLE `ud_hook` CHANGE `name` `name` VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '钩子名称';
ALTER TABLE `ud_hook_plugin` CHANGE `hook` `hook` VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '钩子名';

INSERT INTO `ud_hook` VALUES ('1', '1', '0', '应用初始化', 'app_init', 'imf', '应用初始化'), ('2', '1', '0', '应用开始', 'app_begin', 'imf', '应用开始'), ('3', '1', '0', '模块初始化', 'module_init', 'imf', '模块初始化'), ('4', '1', '0', '控制器开始', 'action_begin', 'imf', '控制器开始'), ('5', '1', '0', '视图输出过滤', 'view_filter', 'imf', '视图输出过滤'), ('6', '1', '0', '应用结束', 'app_end', 'imf', '应用结束'), ('7', '1', '0', '日志write方法', 'log_write', 'imf', '日志write方法'), ('8', '1', '0', '输出结束', 'response_end', 'imf', '输出结束'), ('9', '1', '0', '后台控制器初始化', 'admin_init', 'imf', '后台控制器初始化'), ('10', '1', '0', '前台控制器初始化', 'home_init', 'imf', '前台控制器初始化'), ('11', '1', '1', '发送手机验证码', 'send_mobile_verification_code', 'imf', '发送手机验证码'), ('12', '3', '0', '模板 body标签开始', 'body_start', '', '模板 body标签开始'), ('13', '3', '0', '模板 head标签结束前', 'before_head_end', '', '模板 head标签结束前'), ('14', '3', '0', '模板底部开始', 'footer_start', '', '模板底部开始'), ('15', '3', '0', '模板底部开始之前', 'before_footer', '', '模板底部开始之前'), ('16', '3', '0', '模板底部结束之前', 'before_footer_end', '', '模板底部结束之前'), ('17', '3', '0', '模板 body 标签结束之前', 'before_body_end', '', '模板 body 标签结束之前'), ('18', '3', '0', '模板左边栏开始', 'left_sidebar_start', '', '模板左边栏开始'), ('19', '3', '0', '模板左边栏结束之前', 'before_left_sidebar_end', '', '模板左边栏结束之前'), ('20', '3', '0', '模板右边栏开始', 'right_sidebar_start', '', '模板右边栏开始'), ('21', '3', '0', '模板右边栏结束之前', 'before_right_sidebar_end', '', '模板右边栏结束之前'), ('22', '3', '1', '评论区', 'comment', '', '评论区'), ('23', '3', '1', '留言区', 'guestbook', '', '留言区'), ('24', '2', '0', '后台首页仪表盘', 'admin_dashboard', 'admin', '后台首页仪表盘'), ('25', '4', '0', '后台模板 head标签结束前', 'admin_before_head_end', '', '后台模板 head标签结束前'), ('26', '4', '0', '后台模板 body 标签结束之前', 'admin_before_body_end', '', '后台模板 body 标签结束之前'), ('27', '2', '0', '后台登录页面', 'admin_login', 'admin', '后台登录页面'), ('28', '1', '1', '前台模板切换', 'switch_theme', 'imf', '前台模板切换'), ('29', '3', '0', '主要内容之后', 'after_content', '', '主要内容之后'), ('30', '2', '0', '文章显示之前', 'portal_before_assign_article', 'portal', '文章显示之前'), ('31', '2', '0', '后台文章保存之后', 'portal_admin_after_save_article', 'portal', '后台文章保存之后');


ALTER TABLE `ud_plugin` ADD `demo_url` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '演示地址，带协议' AFTER `title`;
ALTER TABLE `ud_plugin` ADD `author_url` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '作者网站链接' AFTER `author`;

--
-- 2017-07-06 11:10 增加用户操作表
--
DROP TABLE IF EXISTS `ud_user_action`;
CREATE TABLE `ud_user_action` (
...
--
DROP TABLE IF EXISTS `ud_user_score_log`;
CREATE TABLE `ud_user_score_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
ALTER TABLE `ud_portal_post` CHANGE `post_excerpt` `post_excerpt` VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'post摘要';

-- 2017-09-06 10:35更正 admin_menu表list_order 字段类型
ALTER TABLE `ud_admin_menu` CHANGE `list_order` `list_order` FLOAT NOT NULL DEFAULT '10000' COMMENT '排序';

-- 2017-09-07 13:35 增加用户表 more 字段
ALTER TABLE `ud_user` ADD `more` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '扩展属性' AFTER `mobile`;
