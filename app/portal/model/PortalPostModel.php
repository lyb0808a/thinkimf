...
class PortalPostModel extends Model
{
    ...
    {
        return htmlspecialchars(imf_replace_content_file_url(htmlspecialchars_decode($value), true));
    }
    ...
    {
        $data['user_id'] = imf_get_current_admin_id();

        if (!empty($data['more']['thumbnail'])) {
            $data['more']['thumbnail'] = imf_asset_relative_url($data['more']['thumbnail']);
        }
