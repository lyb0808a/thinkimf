<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"themes/admin_tpl/user\admin_asset\index.html";i:1515696438;s:43:"themes/admin_tpl/public\header.html";i:1515696438;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <tr>
                ...
                <td>
                    <?php if(in_array(strtolower($vo['suffix']),$asset_img_suffixes)): ?>
                        <a href="javascript:parent.imagePreviewDialog('<?php echo imf_get_image_preview_url($vo['file_path']); ?>');">
