<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"themes/admin_tpl/admin\theme\index.html";i:1515696438;s:43:"themes/admin_tpl/public\header.html";i:1515696438;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <?php if(is_array($themes) || $themes instanceof \think\Collection || $themes instanceof \think\Paginator): if( count($themes)==0 ) : echo "" ;else: foreach($themes as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php if(($vo['name'] == 'default') OR ($vo['theme'] == $default_theme)): ?>
