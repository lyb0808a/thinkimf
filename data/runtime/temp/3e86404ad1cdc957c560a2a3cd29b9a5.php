<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin_tpl/admin\user\index.html";i:1515696438;s:43:"themes/admin_tpl/public\header.html";i:1515696438;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<?php if($vo['id'] == 1 || $vo['id'] == imf_get_current_admin_id()): ?>
