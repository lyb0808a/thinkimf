<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"themes/admin_tpl/portal\admin_article\index.html";i:1515696438;s:43:"themes/admin_tpl/public\header.html";i:1515696438;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <tr>
                    ...
                    <td>
                        <?php if(!(empty($category) || (($category instanceof \think\Collection || $category instanceof \think\Paginator ) && $category->isEmpty()))): ?>
                            ...
                            <?php else: ?>
                            <a href="<?php echo imf_url('portal/Article/index',array('id'=>$vo['id'])); ?>"
                               target="_blank"><?php echo $vo['post_title']; ?></a>
                        <?php endif; ?>
                    </td>
                    <td>
                        <?php if(is_array($vo['categories']) || $vo['categories'] instanceof \think\Collection || $vo['categories'] instanceof \think\Paginator): if( count($vo['categories'])==0 ) : echo "" ;else: foreach($vo['categories'] as $key=>$voo): ?>
                            <span class="label label-default">
                                <a href="<?php echo imf_url('portal/List/index',array('id'=>$voo['id'])); ?>"
                                   style="color: #fff;"
                                   target="_blank"
                                ><?php echo $voo['name']; ?></a>
                            </span>&nbsp;
                    ...
                    <td>
                        ...
                        <?php endif; if(!(empty($vo['more']['thumbnail']) || (($vo['more']['thumbnail'] instanceof \think\Collection || $vo['more']['thumbnail'] instanceof \think\Paginator ) && $vo['more']['thumbnail']->isEmpty()))): ?>
                            <a href="javascript:parent.imagePreviewDialog('<?php echo imf_get_image_preview_url($vo['more']['thumbnail']); ?>');">
