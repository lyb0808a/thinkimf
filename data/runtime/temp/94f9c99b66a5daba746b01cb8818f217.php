<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin_tpl/admin\main\index.html";i:1516391601;s:43:"themes/admin_tpl/public\header.html";i:1515696438;}*/ ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body home-info">
                <ul class="list-unstyled">
                    <li><em>官网</em> <span><a href="https://www.thinkimf.com" target="_blank">www.thinkcmf.com</a></span>
                    </li>
                    <li><em>QQ 群</em> <span>343012956</span></li>
                    <li><em>联系邮箱</em> <span>unnnnn@foxmail.com</span></li>
                </ul>
            </div>
        </div>
...
<?php 
    \think\Hook::listen('admin_before_head_end',$temp5a6250820d378,null,false);
 ?>
</head>
<body>
<div class="wrap">
...
<script>
    ...
    //获取官方通知
    $.getJSON("https://www.thinkimf.com/service/sms_jsonp.php?lang=<?php echo $lang_set; ?>&v=<?php echo $thinkcmf_version; ?>&callback=?",
        function (data) {
...
<?php 
    \think\Hook::listen('admin_before_body_end',$temp5a6250820d390,null,false);
 ?>
</body>
</html>