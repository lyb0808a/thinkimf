<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:33:"themes/default/portal\\index.html";i:1516432442;s:31:"themes/default/public\head.html";i:1516433688;s:35:"themes/default/public\function.html";i:1516427586;s:30:"themes/default/public\nav.html";i:1516432442;s:33:"themes/default/public\footer.html";i:1516427586;s:34:"themes/default/public\scripts.html";i:1516262603;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
function _sp_helloworld2(){
	echo "hello ThinkIMF2!";
}


function _sp_helloworld3(){
	echo "hello ThinkIMF3!";
}

 ?>
<meta name="author" content="ThinkIMF">
<meta charset="utf-8">
...
<link href="__TMPL__/public/assets/simpleboot3/font-awesome/4.4.0/css/font-awesome.min.css" rel="stylesheet"
      type="text/css">
<!--[if IE 7]>
<link rel="stylesheet" href="__TMPL__/public/assets/default/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
<![endif]-->
...
<script src="__STATIC__/js/wind.js"></script>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp5a7d037dd4f2e,null,false);
 ?>
</head>
...
<nav class="navbar navbar-default navbar-fixed-top active">
    <div class="container active">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="__ROOT__/"><?php echo (isset($theme_vars['company_name']) && ($theme_vars['company_name'] !== '')?$theme_vars['company_name']:'ThinkIMF'); ?></a>
        </div>
...
function __parse_navigation69e45987e5f0e5bcd24c2cfee0fe477a($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation69e45987e5f0e5bcd24c2cfee0fe477a';
...
if(''==''): ?>
    <?php echo __parse_navigation69e45987e5f0e5bcd24c2cfee0fe477a($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation69e45987e5f0e5bcd24c2cfee0fe477a($menus); ?>
    </>
<?php endif; ?>
            ...
            <ul class="nav navbar-nav navbar-right" id="main-menu-user">
                ...
                <li class="dropdown user login">
                    <a class="dropdown-toggle user" data-toggle="dropdown" href="#">
                        <?php $user=imf_get_current_user(); if(empty($user['avatar'])): ?>
                            <img src="__TMPL__/public/assets/images/headicon.png" class="headicon">
                            <?php else: ?>
                            <img src="<?php echo imf_get_user_avatar_url($user['avatar']); ?>" class="headicon" width="30"/>
                        <?php endif; ?>
                        <span class="user-nickname"></span><b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu pull-right">
                        <li><a href="<?php echo imf_url('user/Profile/center'); ?>"><i class="fa fa-user"></i> &nbsp;个人中心</a></li>
                        <li class="divider"></li>
                        <li><a href="<?php echo imf_url('user/Index/logout'); ?>"><i class="fa fa-sign-out"></i> &nbsp;退出</a></li>
                    </ul>
                </li>
                <li class="dropdown user offline" style="display: list-item;">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li><a href="<?php echo imf_url('user/Login/index'); ?>"><i class="fa fa-sign-in"></i> &nbsp;登录</a></li>
                        <li class="divider"></li>
                        <li><a href="<?php echo imf_url('user/Register/index'); ?>"><i class="fa fa-user"></i> &nbsp;注册</a></li>
                    </ul>
                </li>
            </ul>
            <form class="navbar-form navbar-right" method="post" action="<?php echo imf_url('portal/Search/index'); ?>">
...
if(is_array($__SLIDE_ITEMS__) || $__SLIDE_ITEMS__ instanceof \think\Collection || $__SLIDE_ITEMS__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__SLIDE_ITEMS__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        ...
        <li>
            ...
            <a href="<?php echo (isset($vo['url']) && ($vo['url'] !== '')?$vo['url']:''); ?>"><img src="<?php echo imf_get_image_url($vo['image']); ?>" alt=""></a>
        </li>
...
if(count($__SLIDE_ITEMS__) == 0): ?>
        ...
        <li>
            <div class="caption-wraper">
                <div class="caption">PHP 7+</div>
            </div>
            <a href=""><img src="__TMPL__/public/assets/images/default/gtx.jpg" alt=""></a>
        </li>
        <li>
            <div class="caption-wraper">
                <div class="caption">Web 3.0 +</div>
            </div>
            <a href=""><img src="__TMPL__/public/assets/images/default/wx.jpg" alt=""></a>
        </li>
        <li>
            <div class="caption-wraper">
                <div class="caption">Hook 3.0</div>
            </div>
            <a href=""><img src="__TMPL__/public/assets/images/default/xnld.jpg" alt=""></a>
        </li>
...
<div class="container">
 ...
 ?>
        ...
        <?php 
         ...
         $__FOR_START_13903__=1;$__FOR_END_13903__=$rows;for($row=$__FOR_START_13903__;$row <= $__FOR_END_13903__;$row+=1){ 
                $first_row = ($row-1)*3;
                    ...
                    <div class="tc-gridbox">
                        <div class="header">
                            <div class="item-image">
                                <a href="<?php echo imf_url('portal/Article/index',array('id'=>$vo['id'],'cid'=>$vo['category_id'])); ?>">
                                    <?php if(isset($vo['more']['thumbnail'])): if(empty($vo['more']['thumbnail']) || (($vo['more']['thumbnail'] instanceof \think\Collection || $vo['more']['thumbnail'] instanceof \think\Paginator ) && $vo['more']['thumbnail']->isEmpty())): ?>
                                            <img src="__TMPL__/public/assets/images/default-thumbnail.png"
                                                 ...
                                                 alt="">
                                            <?php else: ?>
                                            <img src="<?php echo imf_get_image_url($vo['more']['thumbnail']); ?>"
                                                 class="img-responsive"
                                                 alt="">
                                        <?php endif; else: ?>
                                        <img src="__TMPL__/public/assets/images/default-thumbnail.png"
                            ...
                            <h3>
                                <a href="<?php echo imf_url('portal/Article/index',array('id'=>$vo['id'],'cid'=>$vo['category_id'])); ?>"><?php echo $vo['post_title']; ?></a>
                            </h3>
                            <hr>
                        </div>
                        <div class="body">
                            <p>
                                <a href="<?php echo imf_url('portal/Article/index',array('id'=>$vo['id'],'cid'=>$vo['category_id'])); ?>">...</a>
                            </p>
                        </div>
                    </div>
                </div>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5a7d037dd4f44,null,false);
 ?>
    <div class="links">
        <?php
...
<?php 
    \think\Hook::listen('before_body_end',$temp5a7d037dd4f53,null,false);
 ?>
</body>
</html>
