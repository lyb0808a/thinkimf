<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"themes/admin_tpl/admin\theme\file_widget_setting.html";i:1515696438;s:51:"themes/admin_tpl/admin\theme\functions.html";i:1515696438;s:43:"themes/admin_tpl/public\header.html";i:1515696438;s:49:"themes/admin_tpl/admin\theme\scripts.html";i:1515696438;}*/ ?>
<?php 
                        ...
                        <div>
                            <a href="javascript:uploadOneImage('图片上传','#js-<?php echo $widget; ?><?php echo $varName; ?>-input');">
                                <?php if(empty($vars[$varName]['value'])): ?>
                                    ...
                                    <?php else: ?>
                                    <img src="<?php echo imf_get_image_preview_url($vars[$varName]['value']); ?>"
                                         id="js-<?php echo $widget; ?><?php echo $varName; ?>-input-preview"
                                         width="135" style="cursor: pointer"/>
                                <?php endif; ?>
                            </a>
