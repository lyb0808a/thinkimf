<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:34:"themes/admin_tpl/admin\\login.html";i:1516432492;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8"/>
    ...
    <link href="__TMPL__/public/assets/themes/<?php echo imf_get_admin_style(); ?>/login.css" rel="stylesheet">
    <script>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <h1 class="text-center">ThinkIMF</h1>
