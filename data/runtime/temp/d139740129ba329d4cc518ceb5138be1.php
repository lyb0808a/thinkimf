<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"themes/admin_tpl/admin\plugin\index.html";i:1516388753;s:43:"themes/admin_tpl/public\header.html";i:1515696438;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li><a href="https://www.thinkimf.com/appstore/plugin.html" target="_blank">插件市场</a></li>
			<li><a href="https://www.thinkimf.com/topic/index/index/cat/9.html" target="_blank">插件交流</a></li>
			<li><a href="https://www.thinkimf.com/docs/cmfx/plugin.html" target="_blank">插件文档</a></li>
		</ul>
						...
						<td>
							...
							<?php else: $config=json_decode($vo['config'],true); if(!empty($config)): ?>
								...
								<?php endif; if(!empty($vo['has_admin'])): ?>
									<a href="javascript:parent.openapp('<?php echo imf_plugin_url($vo['name'].'://AdminIndex/index'); ?>','plugin_<?php echo $vo['name']; ?>','<?php echo $vo['title']; ?>')">管理</a>
								<?php else: ?>
