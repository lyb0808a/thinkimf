<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:39:"themes/admin_tpl/admin\index\index.html";i:1516432492;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <meta charset="utf-8">
    <title>ThinkIMF <?php echo lang('ADMIN_CENTER'); ?></title>
    ...
    <link rel="stylesheet" href="__TMPL__/public/assets/themes/<?php echo imf_get_admin_style(); ?>/simplebootadminindex.min.css">
    <style>
        /*-----------------导航hack--------------------*/
        .nav-list > li.open {
            position: relative;
...
<div class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="<?php echo url('admin/index/index'); ?>" class="navbar-brand" style="min-width: 200px;text-align: center;">ThinkIMF</a>
            ...
            <ul class="nav navbar-nav navbar-right simplewind-nav">
                ...
                <li class="light-blue dropdown" style="border-left:none;">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <?php if(isset($admin['avatar']) && $admin['avatar']): ?>
                            <img class="nav-user-photo" width="30" height="30"
                                 src="<?php echo imf_get_user_avatar_url($admin['avatar']); ?>" alt="<?php echo $admin['user_login']; ?>">
                            <?php else: ?>
                            <img class="nav-user-photo" width="30" height="30"
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
                        <?php if(imf_auth_check(imf_get_current_admin_id(),'admin/Setting/site')): ?>
                            <li>
                        ...
                        <?php endif; if(imf_auth_check(imf_get_current_admin_id(),'admin/user/userinfo')): ?>
                            <li>
                        ...
                        <?php endif; if(imf_auth_check(imf_get_current_admin_id(),'admin/Setting/password')): ?>
                            <li>
...
<div class="main-container container-fluid">
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-shortcuts" id="sidebar-shortcuts">
            ...
            <!--
            <?php if(imf_auth_check(imf_get_current_admin_id(),'portal/AdminCategory/index')): ?>
            ...
            <?php endif; if(imf_auth_check(imf_get_current_admin_id(),'portal/AdminArticle/index')): ?>
            ...
            <?php if(imf_auth_check(imf_get_current_admin_id(),'user/AdminAsset/index')): ?>
            ...
            <?php endif; if(imf_auth_check(imf_get_current_admin_id(),'admin/Setting/clearcache')): ?>
            ...
            <?php endif; if(imf_auth_check(imf_get_current_admin_id(),'admin/RecycleBin/index')): ?>
                <a class="btn btn-sm btn-danger"
