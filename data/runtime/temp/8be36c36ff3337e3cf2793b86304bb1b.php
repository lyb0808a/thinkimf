<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:37:"themes/default/portal\\index.html";i:1516392904;s:35:"themes/default/public\head.html";i:1516388994;s:39:"themes/default/public\function.html";i:1516388992;s:34:"themes/default/public\nav.html";i:1516388994;s:37:"themes/default/public\footer.html";i:1516392718;s:38:"themes/default/public\scripts.html";i:1515696439;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script src="__STATIC__/js/wind.js"></script>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp5a6252c3dd8b9,null,false);
 ?>
</head>
...
function __parse_navigationc1f1a12562d7a5fc378a8921d69d57be($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigationc1f1a12562d7a5fc378a8921d69d57be';
...
if(''==''): ?>
    <?php echo __parse_navigationc1f1a12562d7a5fc378a8921d69d57be($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigationc1f1a12562d7a5fc378a8921d69d57be($menus); ?>
    </>
<?php endif; ?>
...
<div class="container">
 ...
 ?>
        ...
        <?php 
         ...
         $__FOR_START_18773__=1;$__FOR_END_18773__=$rows;for($row=$__FOR_START_18773__;$row <= $__FOR_END_18773__;$row+=1){ 
                $first_row = ($row-1)*3;
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5a6252c3dd8d2,null,false);
 ?>
    <div class="links">
        <?php
...
<?php 
    \think\Hook::listen('before_body_end',$temp5a6252c3dd8e0,null,false);
 ?>
</body>
</html>
