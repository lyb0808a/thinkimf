<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"themes/admin_tpl/admin\setting\site.html";i:1516388995;s:43:"themes/admin_tpl/public\header.html";i:1515696438;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
								...
								<div class="col-md-6 col-sm-10">
									...
									<?php if(!empty($admin_settings['admin_password'])): ?>
										...
										<?php 
											...
											$site_domain = imf_get_domain().$root;
										 ?>
						...
						<div class="tab-pane" id="G">
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-10">
									...
									<p class="help-block">
										不能以/结尾；设置这个地址后，请将ThinkIMF下的静态资源文件放在其下面；<br>
										ThinkIMF下的静态资源文件大致包含以下(如果你自定义后，请自行增加)：<br>
