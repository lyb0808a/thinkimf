...
$(function () {
    ...
    $("#task-content-inner").on("click", ".imf-component-tabclose", function () {
...
var task_item_tpl = '<li class="imf-component-tabitem">' +
    '<a class="imf-tabs-item-text"></a>' +
    '<span class="imf-component-tabclose" href="javascript:void(0)" title="点击关闭标签"><span></span><b class="imf-component-tabclose-icon">×</b></span>' +
    '</li>';
...
function openapp(url, appId, appname, refresh) {
    ...
    if ($app.length == 0) {
        ...
        task.find(".imf-tabs-item-text").html(appname).attr("title", appname);
