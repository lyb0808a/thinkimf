...
## This script generates formatted documentation for the default, in RST format.

header('Content-type: text/plain');
echo 'File: **default/index.php**' . PHP_EOL;
...
foreach (file('index.php') as $lineNumber => $line) {
    if (substr(ltrim($line), 0, 2) == '##') {
        if ($codeStart !== false) {
            echo PHP_EOL;
            echo '.. literalinclude:: ../default/index.php' . PHP_EOL;
