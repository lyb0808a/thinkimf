<?php
// +---------------------------------------------------------------------
// | ThinkIMF [ WE CAN DO IT MORE SIMPLE ]
// +---------------------------------------------------------------------
// | Copyright (c) 2013-2014 https://www.thinkimf.com All rights reserved.
// +---------------------------------------------------------------------
...
class Upload
{
    ...
    public function upload()
    {
        ...
        $strFileExtension = strtolower(imf_get_file_extension($originalName));
        ...
        //  $url=$first['url'];
        $storageSetting = imf_get_cmf_settings('storage');
            ...
            if ($needUploadToRemoteStorage) {
                ...
                if (!empty($result)) {
                    return array_merge([
                        ...
                        'id'          => $strId,
                        'preview_url' => imf_get_root() . '/upload/' . $arrInfo["file_path"],
                        'url'         => imf_get_root() . '/upload/' . $arrInfo["file_path"],
                    ], $result);
                }
            } else {
